...
@php
    ...
    $overall     = isset($overall) ? $overall : ['total_visits' => 0, 'met' => 0, 'not_met' => 0, 'unique_customers' => 0, 'total_trials' => 0, 'trials_attached' => 0];
@endphp
...
<td align="center" style="padding: 36px 16px;">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="wrapper">
            ...
            <td class="ribbon">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td align="right">
                            <span class="ribbon-badge">{{ $monthLabel }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td class="section">
                <div class="noact-box">
                    ...
                    <div class="noact-body">
                        No customer visits (DVRs) were found against your account for
                        <strong>{{ $monthLabel }}</strong>. If you did work during this month, please make sure
                        your DVRs are entered in the system, or reach out to your reporting manager.
                    </div>
                </div>
            </td>
        </tr>
            ...
            <td class="section">
                <table class="info-table" cellpadding="0" cellspacing="0" border="0">
                    <tr class="info-table-header">
                        <td colspan="4">◉ &nbsp;Your Month at a Glance</td>
                    </tr>
                    <tr>
                        <td class="glance-cell">
                            <div class="glance-num">{{ $overall['total_visits'] }}</div>
                            <div class="glance-lbl">Total Visits</div>
                        </td>
                        <td class="glance-cell">
                            <div class="glance-num">{{ $overall['met'] }}</div>
                            <div class="glance-lbl">Customers Met</div>
                        </td>
                        <td class="glance-cell">
                            <div class="glance-num">{{ $overall['unique_customers'] }}</div>
                            <div class="glance-lbl">Customers Visited</div>
                        </td>
                        <td class="glance-cell glance-cell-last">
                            <div class="glance-num">{{ $overall['total_trials'] }}</div>
                            <div class="glance-lbl">Trials Done</div>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="section">
                <div class="attach-box">
                    <div class="attach-title">📎 Your detailed monthly report is attached (PDF)</div>
                    <div class="attach-body">
                        The attachment covers your complete month — a date-wise breakdown of visits met/not-met
                        and customers covered, plus a full trial-by-trial status list (report attached or pending).
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td class="section">
                <div class="signoff">
                    Wishing you a focused and productive month ahead. Good luck!
                    <br><br>
                    Best regards,<br>
