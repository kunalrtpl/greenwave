...
@php
    ...
    $counts      = isset($counts) ? $counts : ['yesterday_tasks' => 0, 'visits' => 0, 'work_notes' => 0, 'today_tasks' => 0];
@endphp
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="wrapper">
        ...
        <tr>
            <td class="header">
                ...
                <div class="header-title">Daily Work Report</div>
                <div class="header-date">{{ $reportDateDisplay }} @if(!empty($reportDayName))({{ $reportDayName }})@endif</div>
            </td>
        </tr>
            ...
            <td class="ribbon">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td align="right">
                            <span class="ribbon-badge">Upcoming: {{ $todayDisplay }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td class="section">
                <div class="greeting-box">
                    ...
                    <div class="greeting-body">
                        @if($hasActivity)
                            Great work yesterday! Your <strong>Daily Work Report for {{ $reportDateDisplay }}</strong>
                            is attached with this email. It captures your scheduled tasks, customer visits, and other
                            key developments from the day — along with your <strong>upcoming tasks for today,
                            {{ $todayDisplay }}</strong> — so you can start the day with complete clarity on
                            what's done and what's next.
                        @else
                            Please find attached your <strong>Daily Work Report for {{ $reportDateDisplay }}</strong>,
                            along with your <strong>upcoming tasks for today, {{ $todayDisplay }}</strong>.
                            Take a moment to review your plan for the day and make every visit count.
                        @endif
                    </div>
                </div>
            </td>
            ...
            <td class="section">
                <div class="noact-box">
                    ...
                    <div class="noact-body">
                        ...
                        account for <strong>{{ $reportDateDisplay }}</strong>. If you did work on this day,
                        please make sure your DVRs and work notes are entered in the system, or reach out
            ...
            <td class="section">
                <table class="info-table" cellpadding="0" cellspacing="0" border="0">
                    <tr class="info-table-header">
                        <td colspan="4">◉ &nbsp;Your Day at a Glance</td>
                    </tr>
                    <tr>
                        <td class="glance-cell">
                            <div class="glance-num">{{ $counts['yesterday_tasks'] }}</div>
        ...
        <tr>
            <td class="section">
                <div class="attach-box">
                    <div class="attach-title">📎 Your detailed report is attached (PDF)</div>
                    <div class="attach-body">
                        The attachment covers your complete visit sheets — contacts you met, products
                        discussed, visit details and next plans — plus work notes and today's task list.
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td class="section">
                <div class="signoff">
                    @if($counts['today_tasks'] > 0)
                        You have <strong>{{ $counts['today_tasks'] }} {{ $counts['today_tasks'] == 1 ? 'task' : 'tasks' }}</strong>
                        lined up for today — wishing you a focused and productive day ahead. Good luck!
                    @else
                        Wishing you a focused and productive day ahead. Good luck!
                    @endif
                    <br><br>
                    Best regards,<br>
            ...
            <td class="section" style="padding-bottom: 32px;">
                <div class="footer">
                    ...
                    <div class="footer-text">
                        Greenwave System — Daily Work Report<br>
