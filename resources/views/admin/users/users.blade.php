                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                       <a href="{{action('Admin\UsersController@addEditUser')}}" class="btn btn-primary">Add Employee</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td><input type="text" class="form-control form-filter input-sm" name="department" placeholder="Department"></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
