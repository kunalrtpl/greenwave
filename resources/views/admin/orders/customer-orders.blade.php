            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">Customer Orders</span>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="customer_purchase_order_no" placeholder="Search By PO">
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
...
<script type="text/javascript">
    window.history.pushState("", "", "/admin/customer-orders");
</script>
@stop
