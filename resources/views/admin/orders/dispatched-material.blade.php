                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="invoice_info" placeholder="Search Invoice">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="po_info" placeholder="Search By P.O. No.">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="product_name" placeholder="Search By Product Name">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="batch_info" placeholder="Search By Batch No.">
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="lr_info" placeholder="Search By L.R. NO.">
                                        </td>
                                        <td>
