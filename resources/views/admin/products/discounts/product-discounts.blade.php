            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">SPSOD</span>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                       <a href="{{url('/admin/add-edit-product-discount')}}" class="btn btn-primary">Add SPSOD</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    window.history.pushState("", "", "/admin/product-discounts");
</script>
@stop
