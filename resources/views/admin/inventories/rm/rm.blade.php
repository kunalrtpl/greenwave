            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">Incoming Raw Materials</span>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td><input type="text" class="form-control form-filter input-sm" name="serial_no" value="RM-" ></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td>
                                            <div class="form-group">
                                                <select class="form-control form-filter input-sm" name="status">
                                                    ...
                                                    @foreach(materialStatus('rm','all') as $materialStatus)
                                                    ...
                                                    @else
                                                        @foreach(getInventoryAccess('view') as $materialStatus)
                                                        <option value="{{$materialStatus}}">{{$materialStatus}}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
...
<script type="text/javascript">
    window.history.pushState("", "", "/admin/inventory/rm");
</script>
@stop
