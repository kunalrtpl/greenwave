            ...
            <form method="post" action="{{url('/admin/update-sampling-qty')}}">@csrf
                ...
                <thead>
                    <tr>
                        ...
                        <th>Special Disc.<br>(%)</th>
                        <th>Additional Cost<br>(Rs./kg)</th>
                        <th>Net Price<br>(Rs./kg)</th>
                        <th>
                            Requested Qty
                            <br>
                        ...
                        <th width="25%">
                            Approved Qty
                            <br>
                            <small>(Approved Pack Size)</small>
                        </th>
                        <th>Value</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            Rs.{{$orderItemInfo['price']}}
                        </td>
                        <?php $discounts = array(); ?>
                        @if(!empty($orderItemInfo['discounts']))
                            <?php $discounts  = json_decode($orderItemInfo['discounts'],true); ?>
                        @endif
                        <td>
                            <table class="table  table-bordered">
                                <?php $totalDis = 0; ?>
                                @foreach($discounts as $disInfo)
                                    @if($disInfo['value']>0)
                        ...
                        <td>Rs. {{$orderItemInfo['additional_cost']}}</td>
                         <td>Rs. {{$orderItemInfo['net_price']}}</td>
                        <td>
                            {{$orderItemInfo['qty']}} kg<br>
                            <small>({{$orderItemInfo['pack_size']}} kg Packing)</small>
                        </td>
                        <td>
                            @if($sampleDetails['sample_edited']=="no")
                            @if(in_array($orderItemInfo['product']['id'],$linkedProducts))
                            ...
                            <input class="form-control" type="number" name="actual_qtys[]" value="{{$orderItemInfo['actual_qty']}}" required>
                             <br>
                            <input class="form-control" type="number" name="actual_pack_sizes[]" value="{{$orderItemInfo['actual_pack_size']}}" required>
                            <br>
                    ...
                    @endif
                    <tr>
                        <td style="text-align: right;" colspan="8">Subotal :- Rs.&nbsp;{{$finalSubtotal}} &nbsp; &nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        <td style="text-align: right;" colspan="8">GST :- (+) Rs.&nbsp;{{$sampleDetails['gst']}} &nbsp; &nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        <td style="text-align: right;" colspan="8">Grand Total :-  Rs.&nbsp;{{$sampleDetails['grand_total']}} &nbsp; &nbsp;&nbsp;</td>
                    </tr>
                </tbody>
            </table>
            </form>
