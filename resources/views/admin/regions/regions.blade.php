                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                       <a href="{{action('Admin\RegionController@addEditRegion')}}" class="btn btn-primary">Add Region</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        <td></td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="region" placeholder="Region">
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td>
...
<script type="text/javascript">
    window.history.pushState("", "", "/admin/regions");
</script>
@stop
