            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">Voluntary Dispatches</span>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                       <a href="{{url('/admin/voluntary-dispatch/create')}}" class="btn btn-primary">Add</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <select class="form-control form-filter input-sm" name="dispatch_to">
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <input type="text" class="form-control form-filter input-sm" name="user_info" placeholder="Search By Executive">
                                        </td>
                                        <td>
