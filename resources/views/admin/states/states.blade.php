            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">States</span>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                       <a href="{{action('Admin\StateController@addEditState')}}" class="btn btn-primary">Add State</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    window.history.pushState("", "", "/admin/states");
</script>
@stop
