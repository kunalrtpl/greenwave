            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">Designations</span>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                       <a href="{{action('Admin\DesignationController@addEditDesignation')}}" class="btn btn-primary">Add Designation</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        <td></td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="department" placeholder="Department">
                                        </td>
                                        <td></td>
                                        <td><input type="text" class="form-control form-filter input-sm" name="designation" placeholder="Designation"></td>
                                        <td></td>
                                        <td>
...
<script type="text/javascript">
    window.history.pushState("", "", "/admin/designations");
</script>
@stop
