...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{ url('admin/batch-sheets') }}">Job Cards </a>
            </li>
        </ul>
        <div class="row">
            <div class="col-md-12 ">
                <div class="portlet blue-hoki box ">
                    ...
                    <div class="portlet-body form">
                        <form id="OspMediaForm" role="form" class="form-horizontal" method="post" action="javascript:;" enctype="multipart/form-data" autocomplete="off"> 
                            ...
                            <input type="hidden" name="batch_sheet_id" value="{{$details['id']}}">
                            <div class="form-body">
                                ...
                                <thead>
                                    ...
                                    @foreach($details['medias'] as $mkey=> $media)
                                        <tr>
                                            ...
                                            <td>
                                                <a  class="btn btn-xs btn-danger" href="{{url('admin/delete-batch-sheet-media/'.$media['id'])}}"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </thead>
...
<script type="text/javascript">
    $("#OspMediaForm").submit(function(e){
        ...
        $.ajax({
            url: "{{url('/admin/save-batch-sheet-media')}}",
            type:'POST',
            data: formdata,
            processData: false,
            contentType: false,
