            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">BatchSheets</span>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        <td></td>
                                        <td></td>
                                        <td><input type="text" class="form-control form-filter input-sm" name="product_name" value="" placeholder="Product Name"></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td>
                                            <div class="form-group">
                                                <select class="form-control form-filter input-sm" name="status">
                                                    ...
                                                    @foreach(getIHPAccess('view') as $batchStatus)
                                                        <option value="{{$batchStatus}}">{{$batchStatus}}</option>
                                                    @endforeach
...
@include('admin.batchsheets.batch-tracking')
@stop
